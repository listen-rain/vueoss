    ...
    <div class="form-container">
        <el-form ref="form" label-width="160px">
            ...
            <el-form-item label="点击上传">
                <vueOssUploader :path="path" :debug="true" :name-mode="nameMode" :keySet="keySet" :name="name"
                                v-on:success="uploaded" @error="showError"></vueOssUploader>
            </el-form-item>
